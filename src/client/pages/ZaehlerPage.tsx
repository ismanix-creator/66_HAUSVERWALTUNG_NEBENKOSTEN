  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-400">Zähler</h1>
          <p className="text-gray-600">Alle Zähler Ihrer Objekte zentral erfassen.</p>
        </div>
        <button
          onClick={() => {
            setEditItem(null)
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-600 rounded-lg hover:text-primary-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <Plus className="h-4 w-4" />
              Ablesung erfassen
            </button>
