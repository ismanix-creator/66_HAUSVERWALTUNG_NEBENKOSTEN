...
Zusätzlich: Agenten nutzen die MCP-Tools `filesystem`, `sequential-thinking` und `time` für Dateisystemzugriffe, sequenzielle Denkprozesse und verifizierte Zeitstempel.
